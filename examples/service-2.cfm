<cfset variables.sTitle = "Service 2">

<cfinclude template="header.cfm" >
<cfinclude template="navbar.cfm" >

<div class="content service-two">
  <div class="container">
  ...
  <hr />
      ...
      <div class="row">
         <div class="col-md-12">
           <!-- Section title with font awesome icon -->
           <h5><i class="icon-cloud"></i> Web Services</h5>
         </div>
      </div>
      ...
      <div class="row">
         <div class="col-md-4 col-sm-4">
           ...
           <h6>Web Designing</h6>
           <!-- Service para -->
           <p>Suspesse potenti. Morbi ac felis nec mauris imperdiet fermentum. Aenean sodales augue ac lacus hendrerit sed rhoncus erat hendrerit. Vivamus vel ultricies elit. Nulla vitae cursus leo. </p>
         </div>
         <div class="col-md-4 col-sm-4">
      ...
      <div class="row">
         <div class="col-md-12">
           <hr />
           <h5><i class="icon-envelope-alt"></i> Mobile Services</h5>
         </div>
      </div>
